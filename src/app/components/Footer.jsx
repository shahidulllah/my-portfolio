                ...
                <div className=" bg-base-200 text-base-content rounded flex flex-col justify-center items-center space-y-10 text-center">
                    <nav className="flex flex-wrap gap-5 lg:gap-12 w-full justify-center">
                       ...
                       <Link href={'#projects'}> <h3 className="link link-hover">Projects</h3></Link>
                        ...
                        <Link href={'https://drive.google.com/file/d/1uXOmD4PnDrKKAzbc1zSK8XMJp9lOfeaR/view?usp=drive_link'}><h3 className="link link-hover">Resume</h3></Link>
                        ...
                        <Link href={'https://drive.google.com/file/d/1uXOmD4PnDrKKAzbc1zSK8XMJp9lOfeaR/view?usp=drive_link'}><h3 className="link link-hover">CV</h3></Link>
                    </nav>
                    <nav>
