                ...
                <div className=" bg-base-200 text-base-content rounded flex flex-col justify-center items-center space-y-8 text-center">
                    <nav className="flex flex-wrap gap-5 lg:gap-12 w-full justify-center">
                       ...
                       <Link href={'#projects'}> <h3 className="link link-hover">Projects</h3></Link>
                        ...
                        <Link href={'https://drive.google.com/file/d/1kgnMEap6qKHCua06XVxvQJYIpu6AuRqW/view?usp=sharing'}><h3 className="link link-hover">Resume</h3></Link>
                        ...
                        <Link href={'https://drive.google.com/file/d/1kgnMEap6qKHCua06XVxvQJYIpu6AuRqW/view?usp=sharing'}><h3 className="link link-hover">CV</h3></Link>
                    </nav>
                    <nav>
